      ...
      <table class="min-w-full border border-gray-100 rounded-lg overflow-hidden">
        ...
        <tbody class="divide-y divide-gray-100">
          @if(count($admins)>0)
            ...
            <td class="px-6 py-4 text-sm text-gray-800">{{$admin->name}}</td>
            <td class="px-6 py-4 text-sm text-gray-800">{{$admin->email}}</td>
            <td class="px-6 py-4 text-sm text-gray-800">{{$admin->getRoleNames()[0]}}</td>
